...
public class Xml2 extends JFrame {

	// automatisch über Eclipse ergänzt
	private static final long serialVersionUID = -7886792607104529221L;
	...
	private void dateiLesen() {
		...
		// zur Zwischenspeicherung der Zeichenkette für den Namen eines Tags
		String text = null;
		...
		try {
			...
			eingabeStream = new FileInputStream("liste.xml");
