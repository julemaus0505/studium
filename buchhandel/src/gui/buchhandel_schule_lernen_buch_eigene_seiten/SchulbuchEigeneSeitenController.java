package gui.buchhandel_schule_lernen_buch_eigene_seiten;
...
public class SchulbuchEigeneSeitenController {
	...
	public SchulbuchEigeneSeitenController(Buch buch) {
		this.buch = buch;
	...
	public void grossesBildOeffnen() {
		...
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/schule_lernen_bilder_gross/SchulbuchGrossAnzeigen.fxml"));
