...
public class MiniDBTest extends JFrame {
	...
	private void anlegenDB() {
		...
		try {
			...
			state.execute(
					"CREATE TABLE adressen(iNummer int NOT NULL GENERATED ALWAYS AS IDENTITY(START WITH 1, INCREMENT BY 1), "
							+ "vorname varchar(50) NOT NULL," + "nachname varchar(50) NOT NULL,"
							+ "strasse varchar(50) NOT NULL," + "plz varchar(5) NOT NULL," + "ort varchar(50) NOT NULL,"
							+ "telefon varchar(20)," + "PRIMARY KEY(iNummer))");
