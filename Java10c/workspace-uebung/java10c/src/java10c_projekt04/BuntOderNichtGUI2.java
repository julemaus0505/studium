...
public class BuntOderNichtGUI2 extends JFrame {
		...
		public void itemStateChanged(ItemEvent e) {
			...
			if (ausloeser instanceof JRadioButton) {
				...
				if (bunt.isSelected() == true) {
					...
					// Änderung Farbe Rot wird jetzt gleich angezeigt wenn man auf bunk klickt.
	...
	// der Konstruktor
	public BuntOderNichtGUI2(String titel) {
		super(titel);
